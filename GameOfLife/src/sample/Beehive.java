...
// klasa stanu niezmiennego, który po angielsku nazywamy Beehive (ul)

public class Beehive {


    public Beehive(Canvas canvas, int[][]statesTab, int tmpX, int tmpY, double xSize, double ySize) {
        ...
        graphicsContext.fillRect((tmpX + 2) * xSize, (tmpY + 1) * ySize, xSize, ySize);
